...
const data = [
    {
        ...
        author: '5bc39da35ab2950fb106ed79'
    },
    {
        name: 'Ohio Mountain',
...
async function seedDB() {
    ...
    const campgrounds = await Promise.all(data.map(async d => {
        const [ campground, comment1, comment2 ] = await Promise.all([
            Campground.create(d),
            Comment.create({ text: 'Amazing place!', author: '5bc39da35ab2950fb106ed79' }),
            Comment.create({ text: 'Another comment...', author: '5bc39da35ab2950fb106ed79' })
        ]);
